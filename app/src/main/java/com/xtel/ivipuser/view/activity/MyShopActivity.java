...
import com.xtel.ivipuser.view.activity.inf.IMyShopActivity;
import com.xtel.ivipuser.view.adapter.AdapterRecycleMyShop;
...
public class MyShopActivity extends BasicActivity implements IMyShopActivity {
    ...
    private void initView() {
        ...
        for (int i = 0; i < 100; i++) {
            ...
            recycle.setUrl_img_content("http://www.diaochot.com/wp-content/uploads/2014/09/khu-vuc-dang-ky-xem-phim-tai-can-ho-the-cbd-quan-2.jpg");
