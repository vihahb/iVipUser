...
public class FragmentShopPresenter {

    private IFragmentShopView view;

    public FragmentShopPresenter(IFragmentShopView view) {
        this.view = view;
    }

    public void getShop(final int type, final int page, final int pagesize) {
        ...
        HomeModel.getInstance().getShopNews(url_shop, session, new ResponseHandle<RESP_ListNews>(RESP_ListNews.class) {
            ...
            public void onSuccess(RESP_ListNews obj) {
                ...
                view.onGetShopSuccess(obj.getData());
            }
