...
public class AdapterRecycleTechnology extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    Random random = new Random();
    private ArrayList<RESP_NewEntity> arrayList;
    private IFragmentTechnologyView technologyView;
    private ArrayList<Integer> background_alpha_item;
    private boolean isLoadMore = true;
    private int TYPE_VIEW = 1, TYPE_LOAD = 2;

    public AdapterRecycleTechnology(ArrayList<RESP_NewEntity> arrayList, IFragmentTechnologyView technologyView) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == TYPE_VIEW) {
            return new ViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.recyclerview_item_technology, parent, false));
        ...
        if (holder instanceof ViewHolder) {
            ...
            holder.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    technologyView.onItemClick(position, newsEntity, v);
                }
            });
        } else {
