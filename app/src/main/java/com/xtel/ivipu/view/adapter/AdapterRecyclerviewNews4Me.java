...
public class AdapterRecyclerviewNews4Me extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AdapterRecyclerviewNews4Me(ArrayList<RESP_NewEntity> arrayList, IFragmentNews4MeView view) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == TYPE_VIEW) {
            return new ViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.recyclerview_news_4_me, parent, false));
