...
public class AdapterRecyclerFashion extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private ArrayList<RESP_NewEntity> arrayList;
    private IFragmentFashionView fragmentFashionView;
    ...
    public AdapterRecyclerFashion(ArrayList<RESP_NewEntity> arrayList, IFragmentFashionView fragmentFashionView) {
        this.arrayList = arrayList;
        this.fragmentFashionView = fragmentFashionView;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == TYPE_VIEW) {
            return new ViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.recyclerview_item_movie, parent, false));
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        if (position == arrayList.size()) {
            fragmentFashionView.onLoadMore();
        }
        ...
        if (holder instanceof ViewHolder) {
            ...
            viewHolder.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    fragmentFashionView.onItemClick(position, newsEntity, v);
                }
            });
            background_position++;
        } else {
